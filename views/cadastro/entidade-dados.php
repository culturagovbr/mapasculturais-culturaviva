    ...
    <div class="form">
        ...
        <div class="row">
            <label class="colunm-full">
                <span class="destaque">
                    ...
                    <i class='hltip'
                       title='Este e-mail será utilizado pela Secretaria para comunicação, chamada de atualização, realização de pesquisa e quaisquer outros contatos que se fizerem necessários.'>?</i>
                </span>
                <input required name="emailPrivado" type="email" ng-blur="save_field('emailPrivado')"
                       ng-model="agent.emailPrivado">
        ...
        <div class="row">
            <label class="colunm1" style="width:300px;">
                ...
                <input required name="telefone1" type="text" ng-blur="save_field('telefone1')"
                       ng-model="agent.telefone1" ui-mask="(99) ?99999-9999">
        ...
        <div>
            <div class="row">
                <label class="colunm1">
                    <span class="destaque">Endereço {{agent.tipoPonto == 'ponto_coletivo' ? 'do Coletivo' : 'da Entidade'}}* <i
                                class='hltip'
                                title='Endereço atrelado ao CNPJ (não precisa ser o mesmo endereço do Ponto de Cultura)'>?</i></span>
                </label>
            </div>
            <div class="clear"></div>
            <div class="row">
                ...
                <label class="colunm2" ng-if="agent.pais !== 'Brasil'">
                    <span class="destaque">Estado</span>
                    <input required name="En_Estado" type="text" ng-blur="save_field('En_Estado')"
                           ng-model="agent.En_Estado"/>
                </label>

                <label class="colunm2" ng-class="{busy: cidadecoder.busy}">
                    <span class="destaque">{{agent.pais == 'Brasil' ? 'Cidade*' : 'Cidade'}}</span>
                    <input required name="En_Municipio" type="text"
                           ng-blur="save_field('En_Municipio'); cidadecoder.code(agent.En_Municipio, agent.pais)"
                ...
                <label class="colunm2" ng-class="{'busy': cepcoder.busy}">
                    ...
                    <input required type="text"
                           ...
                           ng-model="agent.cep"
                           ng-if="agent.pais !== 'Brasil'">
                    <span ng-class="error" style="color: red"
                          ng-show="form_entity.cep.$error.required">CEP Obrigatória</span>
                </label>
            </div>
            <div class="clear"></div>
            <div class="row">
                <label class="colunm2">
                    ...
                    <input required name="En_Nome_Logradouro" type="text"
                           ng-blur="save_field('En_Nome_Logradouro'); endcoder.code();"
                           ng-model="agent.En_Nome_Logradouro"/>
                ...
                <label class="colunm2">
                    ...
                    <input required name="En_Bairro" type="text" ng-blur="save_field('En_Bairro'); endcoder.code();"
                           ng-model="agent.En_Bairro"/>
        ...
        <div class="form form-mapa">
            <style type="text/css">.leaflet-canvas {
                    min-height: 400px;
                }</style>
        ...
        <div class="row">
            <label class="colunm1">
                <span class="destaque">Nome do Responsável {{agent.tipoPonto == 'ponto_coletivo' ? 'pelo Coletivo' : 'pela Entidade'}}* <i
                            class='hltip' title='Pessoa que representa o Ponto de Cultura'>?</i></span>
                <input name="responsavel_nome" type="text" ng-blur="save_field('responsavel_nome')"
                       ng-model="agent.responsavel_nome"/>
            ...
            <label class="colunm05">
                ...
                <input type="text" ui-mask="999.999.999-99" name="responsavel_cpf" type="text"
                       ng-blur="save_field('responsavel_cpf')" ng-model="agent.responsavel_cpf"/>
        ...
        <div class="row">
            <label class="colunm1">
                ...
                <input name="responsavel_email1" type="email" ng-blur="save_field('responsavel_email1')"
                       ng-model="agent.responsavel_email1"/>
            ...
            <label class="colunm05">
                ...
                <input name="responsavel_telefone" type="text" ng-blur="save_field('responsavel_telefone')"
                       ng-model="agent.responsavel_telefone" ui-mask="(99) ?99999-9999"/>
