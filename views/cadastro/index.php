...
-->
  ...
  <div class="page-base-form">
    <button ng-show="data.statusInscricao < 3" class="btn-validar" ng-disabled="(agent.termos_de_uso === null || agent.termos_de_uso === '0')" ng-click="enviar()"> {{data.statusInscricao > 0 ? 'Atualizar' : 'Enviar'}} </button>
    <button ng-show="data.statusInscricao == 3" class="btn-validar" ng-disabled="(agent.termos_de_uso === null || agent.termos_de_uso === '0')" ng-click="enviar()"> Reenviar </button>
