...
return [
    ...
    'auth.config' => array(
        ...
        'auth_endpoint' => 'https://hmg-id.cultura.gov.br/oauth/v2/auth',
        'token_endpoint' => 'https://hmg-id.cultura.gov.br/oauth/v2/token',
        /*
        Nova ?
        ...
        */
        'user_info_endpoint' => 'https://hmg-id.cultura.gov.br/api/v1/person.json',
        'onCreateRedirectUrl' => 'http://hmg.culturaviva.gov.br/rede/entrada'
    )
];
